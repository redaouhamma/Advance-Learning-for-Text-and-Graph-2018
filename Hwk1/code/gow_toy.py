...
for w in range(2,11):
    ...
    # print density of g
    print g.density()
print "\n We remark that the density grows with the window size which is intuitive since a bigger windows gives more information hence more links \n"

g = terms_to_graph(my_tokens, 11)
#layout = g.layout("kk")
