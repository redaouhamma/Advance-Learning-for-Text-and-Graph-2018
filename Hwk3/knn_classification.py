...
path_root ="D:\MVA\AlteGrad2018\3rd" # fill me!
...
for idx,doc in enumerate(cleaned_docs):
    ...
    doc_embeddings = np.concatenate([my_vector_getter(token,w2v) for token in doc])
    centroid = np.mean(doc_embeddings, axis=0).reshape(1,-1)
